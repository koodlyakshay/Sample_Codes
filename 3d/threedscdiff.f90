! Solve 3-D scalar advection diffusion equation
...
integer             :: Nx,Ny,Nz
real*8              :: x(Nmax), y(Nmax), z(Nmax), xf(Nmax+1), yf(Nmax+1), zf(Nmax+1)
real*8              :: dx(Nmax), dy(Nmax), dz(Nmax), vol(Nmax,Nmax,Nmax)
real*8              :: phi(Nmax,Nmax,Nmax), phi_n1(Nmax,Nmax,Nmax), exact(Nmax,Nmax,Nmax)
real*8              :: dphidx(Nmax,Nmax,Nmax), dphidy(Nmax,Nmax,Nmax), dphidz(Nmax,Nmax,Nmax)
real*8              :: dt, Ux, Uy, Uy, mu, Tf
real*8              :: Lxmax, Lx, Lymax, Ly, Lz, Lzmax
real*8              :: exp_ratio_x, exp_ratio_y, exp_ratio_z, init_dx, init_dy, init_dz
real*8              :: phi_nvd, beta, gamma, eps, err, pi, theta, mu
real*8              :: bc_x(Nmax), bc_y(Nmax),
